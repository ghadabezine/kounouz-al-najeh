                  ...
                  <PageTransition key="chapters">
                    <ChapterList
                      ...
                      onFileUpload={(chapter) =>
                        navigateTo("fileUpload", selectedSubject, chapter)
                      }
                      onCreateQuiz={(chapter) =>
                        navigateTo("createQuiz", selectedSubject, chapter)
                      }
                      onViewQuizzes={(chapter) =>
                        navigateTo("viewQuizzes", selectedSubject, chapter)
                      }
                      isDarkMode={isDarkMode}
                    />
                  </PageTransition>
